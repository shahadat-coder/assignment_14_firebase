...
import 'package:module14_firebase_assignment/firebase_notification.dart';
          ...
          children: [
            SizedBox(
              ...
              child: Row(
                ...
                children:   [
                  Text('Brazil Vs Germany',style: TextStyle(fontSize: 20,),),
                  IconButton(onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const MatchOne() ));
            ...
            SizedBox(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children:   [
                  Text('Argentina Vs France',style:  TextStyle(fontSize: 20,)),
                  IconButton(onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>  const MatchTwo() ));
                  }, icon:const Icon(Icons.arrow_forward,color:Colors.blue,)
                  ),
                ],
              ),
